    ...
    async def playerCommand(interaction: Interaction, minecraft_username: str):
        ...
        if res["success"] == True and res2["success"] == True and res3["success"] == True:
            ...
            if res2["session"]["online"] == True:
                ...
                embed.set_author(name=f"{minecraft_username}'s Stats", icon_url=f"https://starlightskins.lunareclipse.studio/render/pixel/{uuid}/face")
                ...
                await interaction.channel.response.edit_message(" ",embed=embed)
